      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/signup" className="text-gray-300 hover:text-white transition-colors">Join as Provider</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300 text-sm">Iloilo City, Philippines</span>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300 text-sm">hello@icateryou.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © 2024 iCATERYou. All rights reserved. Made with ❤️ in Iloilo City.
          </p>
        </div>
      </div>
    </footer>
